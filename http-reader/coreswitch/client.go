...
//
// Embedded from pkg/coreswitch — copied here so snmp-reader is self-contained
// and can live in its own repo (gitlab.com/iot-team4/product/qube/snmp-reader).
//
// Usage:
//
//	client := coreswitch.NewClient("http://core-switch:8585", "snmp-reader")
...
type Client struct {
	...
	sender     string // identifies this reader (e.g., "snmp-reader")
}

// NewClient creates a core-switch client.
// baseURL is typically "http://core-switch:8585".
// sender is the reader name (e.g., "snmp-reader").
