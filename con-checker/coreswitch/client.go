// Package coreswitch provides an HTTP client for sending alerts to core-switch.
// This matches the existing core-switch v3 schema.DataIn format exactly.
//
// Embedded from pkg/coreswitch — copied here so con-checker is self-contained
// and can live in its own repo (gitlab.com/iot-team4/product/qube/con-checker).
package coreswitch
...
// Client sends data and alerts to core-switch via HTTP POST.
type Client struct {
	baseURL    string
